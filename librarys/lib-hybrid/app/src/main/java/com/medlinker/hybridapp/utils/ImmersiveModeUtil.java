package com.medlinker.hybridapp.utils;
...
import com.medlinker.hybridapp.R;
...
public class ImmersiveModeUtil {
    ...
    private static View createStatusBarView(Activity activity, @ColorInt int color) {
        ...
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, WVUtils.Companion.getStatusBarHeight(activity));
