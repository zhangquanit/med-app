...
import com.medlinker.widget.dialog.MLBottomCustomViewDialog;
 ...
 */
public class BottomDialogFragment extends MLBottomCustomViewDialog {
...
//            layoutParams.height = dm.widthPixels * 3 / 5;
            ...
            layoutParams.width = ConvertUtils.dp2px(270);
            layoutParams.height = ConvertUtils.dp2px(265);
            layoutParams.gravity = Gravity.CENTER;
            getDialog().setCanceledOnTouchOutside(false);
        } else if (mType == 6) {
            layoutParams.width = ConvertUtils.dp2px(270);
            layoutParams.height = ConvertUtils.dp2px(372.5f);
            layoutParams.gravity = Gravity.CENTER;
            getDialog().setCanceledOnTouchOutside(true);
        } else if (mType == 7) {
            layoutParams.width = ConvertUtils.dp2px(302f);
            layoutParams.height = ConvertUtils.dp2px(216.5f);
            layoutParams.gravity = Gravity.CENTER;
            getDialog().setCanceledOnTouchOutside(true);
        }
