...
public class RichBottomDialog {
    ...
    public void setDialogView(LinearLayout rootView) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            final OnViewItemClickListener listener = dialogViewItem.itemClickListener;
            View view = LayoutInflater.from(context).inflate(R.layout.pick_view_bottom_textview, null);
    ...
    public static class Builder {
        ...
        public Builder addViewItem(String strItem, OnViewItemClickListener listener) {
        ...
        public RichBottomDialog build() {
            ...
            BottomDialogFragment dialogFragment = BottomDialogFragment.newInstance(R.layout.pick_view_linearlayout);
