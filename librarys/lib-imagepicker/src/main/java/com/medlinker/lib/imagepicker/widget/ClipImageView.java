...
public class ClipImageView extends ImageView implements
    ...
    public ClipImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PickerClipImageView);
        mWidth = ta.getInteger(R.styleable.PickerClipImageView_civWidth, 1);
        mHeight = ta.getInteger(R.styleable.PickerClipImageView_civHeight, 1);
        mClipPadding = ta.getDimensionPixelSize(R.styleable.PickerClipImageView_civClipPadding, 0);
        mMaskColor = ta.getColor(R.styleable.PickerClipImageView_civMaskColor, 0xB2000000);
        ta.recycle();
     ...
     * @param height 高
     */
    public void setClipScale(int width,int height){
        this.mWidth=width;
        this.mHeight=height;
//        invalidate();
    }
