...
public class DecodeThread extends Thread {
    ...
    public DecodeThread(InnerOnDecodeListener decodeListener, Handler resultHandler, int decodeMode) {
    ...
    public void run() {
        Looper.prepare();
        handler = new DecodeHandler(mDecodeListener, mResultHandler, hints);
