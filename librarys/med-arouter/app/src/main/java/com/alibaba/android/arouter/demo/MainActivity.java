    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.navByName:
                ...
                break;
            case R.id.navByName2:
                ((HelloService) ARouter.getInstance().build("/yourservicegroupname2/hello").navigation()).sayHello("mike");
                break;
            case R.id.navByType:
            ...
            case R.id.dynamicNavigation:
                ...
                break;
            case R.id.grouptest_same: //不同module相同group
                ARouter.getInstance().build("/test/libA_classC?key1=1&key2=helloworld").navigation();
                break;
            default:
                break;
        }
