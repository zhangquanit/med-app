...
import net.medlinker.im.im.HearbeatSchedulerImp;
...
public class ImBaseReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null && intent.getAction().equalsIgnoreCase(Constants.getImReceiverAction(context))) {
        ...
        } else if (intent != null && intent.getAction().equalsIgnoreCase(HearbeatSchedulerImp.HEART_BEAT_ACTION)) {
            ImManager.sendPing();//接受到心跳包发送心跳
        }
    }
