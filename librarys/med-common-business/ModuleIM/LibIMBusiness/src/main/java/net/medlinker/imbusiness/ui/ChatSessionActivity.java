...
public class ChatSessionActivity extends BaseActivity {
    ...
    private void initObserver() {
        mNavigationBar.showCenterTitle("");
//        mViewModel.getGroupInfoLiveData().observe(this, new Observer<GroupImInfoEntity>() {
//            @Override
//            public void onChanged(GroupImInfoEntity groupImInfo) {
//                if (null != groupImInfo) {
//                    mNavigationBar.setTitle(String.format(getString(R.string.txt_doctor_team),
//                            groupImInfo.getBusinessInfo().getDoctorInfo().getDoctorName()));
//                }
//            }
//        });
    }
