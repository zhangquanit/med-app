 ...
 * @time 17/2/14
 */
public abstract class BaseSimpleListAdapter<T> extends Adapter<RecyclerView.ViewHolder> {

    protected Context mContext;
    protected List<T> mDataList = new ArrayList<>();
    protected OnItemClickListener<T> mOnItemClickListener;

    protected IItemChildOnClickListener mIItemChildOnClickAction;
    ...
    public void setItemChildOnClickListener(IItemChildOnClickListener onClickListener) {
