 ...
 */
public class MedAsyncJobUtil<JobResult> {
    ...
    /**
     * Instantiates a new AsyncJobUtil
     */
    public MedAsyncJobUtil() {
    }
    ...
    /**
     * Cancels the AsyncJobUtil interrupting the inner thread.
     */
    public void cancel() {
        if (actionInBackground != null) {
    ...
    /**
     * Builder class to instantiate an AsyncJobUtil in a clean way
     *
    ...
    public static class AsyncJobBuilder<JobResult> {
        ...
        /**
         * Instantiates a new AsyncJobUtil of the given type
         *
         * @return a configured AsyncJobUtil instance
         */
        public MedAsyncJobUtil<JobResult> create() {
            MedAsyncJobUtil<JobResult> AsyncJobUtil = new MedAsyncJobUtil<JobResult>();
            AsyncJobUtil.setActionInBackground(asyncAction);
            AsyncJobUtil.setActionOnResult(asyncResultAction);
            AsyncJobUtil.setExecutorService(executor);
            return AsyncJobUtil;
        }
