 ...
 */
public class MedContactsUtil {
    private static MedContactsUtil mInstance;

    public static MedContactsUtil getInstance() {
        if (mInstance == null) {
            synchronized (MedContactsUtil.class) {
                if (mInstance == null) {
                    mInstance = new MedContactsUtil();
                }
            }
        }
        return mInstance;
