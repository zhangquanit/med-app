package com.medlinker.login.widget;
...
/**
 * 参考：
 * https://github.com/zktzktzkt/SplitEditTextView/
 */
public class SplitEditTextView extends AppCompatEditText {
    ...
    private void initAttrs(Context c, AttributeSet attrs) {
        ...
        mBorderSize = array.getDimension(R.styleable.SplitEditTextView_et_borderSize, dp2px(1f));
        mBorderColor = array.getColor(R.styleable.SplitEditTextView_et_borderColor, Color.BLACK);
        mCornerSize = array.getDimension(R.styleable.SplitEditTextView_et_cornerSize, 0f);
        mDivisionLineSize = array.getDimension(R.styleable.SplitEditTextView_et_divisionLineSize, dp2px(1f));
        mDivisionColor = array.getColor(R.styleable.SplitEditTextView_et_divisionLineColor, Color.BLACK);
        mCircleRadius = array.getDimension(R.styleable.SplitEditTextView_et_circleRadius, dp2px(5f));
        mContentNumber = array.getInt(R.styleable.SplitEditTextView_et_contentNumber, 6);
        mContentShowMode = array.getInteger(R.styleable.SplitEditTextView_et_contentShowMode, CONTENT_SHOW_MODE_PASSWORD);
        mInputBoxStyle = array.getInteger(R.styleable.SplitEditTextView_et_inputBoxStyle, INPUT_BOX_STYLE_CONNECT);
        mSpaceSize = array.getDimension(R.styleable.SplitEditTextView_et_spaceSize, dp2px(10f));
        ...
        mInputBoxSquare = array.getBoolean(R.styleable.SplitEditTextView_et_inputBoxSquare, true);
        mCursorColor = array.getColor(R.styleable.SplitEditTextView_et_cursorColor, Color.BLACK);
        mCursorDuration = array.getInt(R.styleable.SplitEditTextView_et_cursorDuration, 500);
        mCursorWidth = array.getDimension(R.styleable.SplitEditTextView_et_cursorWidth, dp2px(2f));
        mCursorHeight = (int) array.getDimension(R.styleable.SplitEditTextView_et_cursorHeight, 0);
        mUnderlineNormalColor = array.getInt(R.styleable.SplitEditTextView_et_underlineNormalColor, Color.BLACK);
        mUnderlineFocusColor = array.getInt(R.styleable.SplitEditTextView_et_underlineFocusColor, 0);
        array.recycle();
        init();
    }
        ...
        if (mInputBoxSquare) {
            ...
            switch (mInputBoxStyle) {
                case INPUT_BOX_STYLE_UNDERLINE:
                    int height = (int) (itemWidth + mBorderSize);
